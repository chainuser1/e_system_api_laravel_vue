    ...
    <div class="container bootdey flex-grow-1 container-p-y">
        ...
        <div class="media align-items-center py-3 mb-3">
            ...
            <div class="media-body ml-4">
                <h4 class="font-weight-bold mb-0">{{person.first_name + ' ' +person.last_name}}<span
                        class="text-muted font-weight-normal">{{!person.user?'':'@'+person.user.username}}</span>
                </h4>
                <div class="text-muted mb-2">SRN/EMP.ID: &nbsp;
                    {{!person.student_number?person.employee_number:person.student_number}}</div>
            ...
            <div class="card-body">
                <table class="table user-view-table m-0">
                    <tbody>
                        ...
                        <tr>
                            <td>User Role:</td>
                            <td>{{!person.user?'':person.user.role}}</td>
                        </tr>
                        <tr>
                            <td>Status:</td>
                            <td><span class="badge badge-outline-success">{{person.status?person.status:''}}</span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="card-body">
                ...
                <table class="table user-view-table m-0">
                    <tbody>
                        <tr>
                            <td>Username:</td>
                            <td>{{!person.user?'':person.user.username}}</td>
                        </tr>
                        <tr>
                            <td>Name:</td>
                            <td>{{person.last_name}},&nbsp; {{person.first_name}}&nbsp;{{person.middle_name}}&nbsp;{{person.suffix}}
                            </td>
                        </tr>
                        <tr>
                            <td>E-mail:</td>
                            <td>{{!person.user?'':person.user.email}}</td>
                        </tr>
                        <tr>
                            <!-- <td>Company:</td>
                            <td>Company Ltd.</td> -->
...
export default{
    ...
    // watch:{
    //     "$store.getters.person":function(nVal){
    //         this.person = nVal;
    //     }
    // }
}
